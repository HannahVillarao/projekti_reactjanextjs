      ...
      <div className="max-w-lg mx-auto bg-gray-800/60 backdrop-blur p-8 rounded-2xl shadow-md border border-gray-700 space-y-6">
        ...
        <form action={createInvoice} className="space-y-6">
          ...
          <input
            ...
            className="w-full p-3 rounded-xl bg-gray-900/40 border border-gray-700 text-gray-200 focus:ring-2 focus:ring-blue-400"
            required
          />
          ...
          <button
            type="submit"
            className="w-full p-3 rounded-xl bg-green-500/20 text-green-200 font-semibold hover:bg-green-500/30 transition-all border border-green-500/20"
          >
            Create Invoice
          </button>
        </form>
